...
Public Class UpLoadForm
    ...
    Private Const ScreenShotJpg As String = "screenShotJpg.jpg"

    Private Const ScreenShotBmp As String = "screenShotBmp.bmp"

    Private Const CameraJpg As String = "cameraJpg.jpg"

    Private Const CameraBmp As String = "cameraBmp.bmp"

    Private _workAcq As AccessControlQuery

    Private _channel As String

    Private _tapeIdentificationList As String(,) = {{"新闻综合", "1"}, _
                                                    {"都市生活", "2"}, _
                                                    {"影视娱乐", "3"}, _
                                                    {"南宁公共", "4"}}

    Public DY_Upload_TapeNameTextBox As Integer = 11

    Public DY_Upload_StartTimeCodeTextBox As Integer = 0

    Public DY_Upload_EndTimeCodeTextBox As Integer = 1

    Public DY_Upload_LengthTextBox As Integer = 2

    Public DY_Upload_UpLoadChannelTextBox As Integer = 0

    Public DY_Upload_UploadSignalSourceTextBox As Integer = 2

    Public DY_Upload_UploadTaskTypeTextBox As Integer = 1

    Public DY_Upload_UploadProgramTypeTextBox As Integer = 8

    Public DY_Upload_UploadTapeFlageTextBox As Integer = 9

    Public DY_Upload_UpLoadChannelComboBox As Integer = 0

    Public DY_Upload_UploadSignalSourceComboBox As Integer = 1

    Public DY_Upload_UploadTaskTypeComboBox As Integer = 2

    Public DY_Upload_UploadProgramTypeComboBox As Integer = 5
    ...
    Private Sub UpLoadForm_Disposed _
    ...
    Private Sub UpLoadForm_Load _
        ...
        '按照panel1调整窗口大小
        Me.Height = System.Windows.Forms.SystemInformation.CaptionHeight + Panel1.Height
    ...
    Private Sub SetTapeInfo()
        ...
        Try
            ...
            If (reader.Read()) Then
                ...
                inbcsttimecode = (reader("start_timecode"))       '当前编辑的项目的创建起始时码
                inbclengthcode = (reader("length"))               '当前编辑的项目的创建时长
                inbcendtimecode = (reader("end_timecode"))        '当前编辑的项目的创建终止时码
    ...
    Private Sub ButtonScreenShotOfDaYangUpload_Click _
        (ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub ButtonScreenShotOfCamera_Click _
        (ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub ButtonGoBack_Click _
        (ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub ButtonInquiry_Click _
        (ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub ButtonStartUpload_Click _
        (ByVal sender As Object, ByVal e As EventArgs) _
        ...
        '磁带时长
        Dim length = TextBoxUploadLenHour.Text & ":" & _
                     TextBoxUploadLenMin.Text & ":" & _
        ...
        '将上载信息写入数据库 
        Const queryS1 As String = "insert into material (" & _
                                  "material_name, " & _
                                  "id, " & _
                                  "tape_id, " & _
                                  "start_timecode, " & _
        ...
        Dim param1() As SqlParameter = { _
                                ...
                                New SqlParameter("@status", StatusUploading) _
                                }

        Const queryS2 As String = "insert into upload (" & _
                                  "tape_name, " & _
                                  "tape_id, " & _
                                  "material_id, " & _
                                  "upload_time, " & _
        ...
        Dim param2() As SqlParameter = { _
                                ...
                                New SqlParameter("@upload_status", StatusUploading) _
                                }

        Dim queryS3 As String = "select count(material_id) " & _
                                "from upload " & _
                                "where " & _
        ...
        Set_Edit_Str(tapeName, DY_Upload_TapeNameTextBox)
        Set_Upload_TimeCode(startTimeCode, DY_Upload_StartTimeCodeTextBox)
        Set_Upload_TimeCode(endTimeCode, DY_Upload_EndTimeCodeTextBox)
        Set_Upload_TimeCode(length, DY_Upload_LengthTextBox)
       
        Set_Edit_Str(programType, DY_Upload_UploadProgramTypeTextBox)
        Set_Edit_Str(tapeIdentification, DY_Upload_UploadTapeFlageTextBox)
    ...
    Private Sub ButtonFinishUpload_Click _
        (ByVal sender As Object, ByVal e As EventArgs) _
        ...
        Const queryS1 As String = "update material set " & _
                                  "status = @status " & _
                                  "where " & _
                                  "id = @material_id"
    ...
    Private Sub ButtonStopUpload_Click _
        (ByVal sender As Object, ByVal e As EventArgs) _
        ...
        Const queryS1 As String = "delete material " & _
                                  "where " & _
                                  "id = @material_id"
    ...
    Private Sub SetRightOrWrongImageVisible(ByVal right As PictureBox, ByVal wrong As PictureBox)
        If _
            TextBoxUploadStartTimeCodeHour.Text = _
            LableRecvHourOfStartTimeCode.Text And _
            TextBoxUploadStartTimeCodeMin.Text = _
    ...
    Private Sub TimeInputCheck _
        (ByVal thisTextBox As TextBox, _
    ...
    Private Sub TextBoxUploadStartTimeCodeHour_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxUploadStartTimeCodeHour.Click
    ...
    Private Sub TextBoxUploadStartTimeCodeHour_TextChanged _
        ...
        TimeInputCheck(CType(sender, TextBox), TextBoxUploadStartTimeCodeMin, 24)
        SetRightOrWrongImageVisible(PB3, PB5)
        SetButtonStartUpload()
    End Sub

    Private Sub TextBoxUploadStartTimeCodeMin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxUploadStartTimeCodeMin.Click
        CType(sender, TextBox).SelectAll()
    End Sub

    Private Sub TextBoxUploadStartTimeCodeMin_TextChanged _
        (ByVal sender As Object, ByVal e As EventArgs) _
        Handles TextBoxUploadStartTimeCodeMin.TextChanged

        TimeInputCheck(CType(sender, TextBox), TextBoxUploadStartTimeCodeSec, 59)
        SetRightOrWrongImageVisible(PB3, PB5)
        SetButtonStartUpload()
    End Sub

    Private Sub TextBoxUploadStartTimeCodeSec_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxUploadStartTimeCodeSec.Click
        CType(sender, TextBox).SelectAll()
    End Sub

    Private Sub TextBoxUploadStartTimeCodeSec_TextChanged _
        (ByVal sender As Object, ByVal e As EventArgs) _
        Handles TextBoxUploadStartTimeCodeSec.TextChanged

        TimeInputCheck(CType(sender, TextBox), TextBoxUploadStartTimeCodeFrame, 59)
        SetRightOrWrongImageVisible(PB3, PB5)
        SetButtonStartUpload()
    End Sub

    Private Sub TextBoxUploadStartTimeCodeFrame_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxUploadStartTimeCodeFrame.Click
        CType(sender, TextBox).SelectAll()
    End Sub
    ...
    Private Sub TextBoxUploadLenHour_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxUploadLenHour.Click
        CType(sender, TextBox).SelectAll()
    End Sub

    Private Sub TextBoxUploadLenHour_TextChanged _
        (ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub TextBoxUploadLenMin_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxUploadLenMin.Click
        CType(sender, TextBox).SelectAll()
    End Sub

    Private Sub TextBoxUploadLenMin_TextChanged _
        (ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub TextBoxUploadLenSec_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxUploadLenSec.Click
        CType(sender, TextBox).SelectAll()
    End Sub

    Private Sub TextBoxUploadLenSec_TextChanged _
        (ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub TextBoxUploadLenFrame_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles TextBoxUploadLenFrame.Click
        CType(sender, TextBox).SelectAll()
    End Sub

    Private Sub TextBoxUploadLenFrame_TextChanged _
        (ByVal sender As Object, ByVal e As EventArgs) _
    ...
    Private Sub CalEndTime()
        ...
        If endTimeH < 0 Then '结束时码小于0，输入错误
            MsgBox("时码错误!")
        Else '输出，不足2位的补0
            TextBoxUploadEndTimeCodeFrame.Text = Microsoft.VisualBasic.Right _
                ("00" & endTimeF, 2) _
            '帧，结果的左边补2个0后取右边2位
            TextBoxUploadEndTimeCodeSec.Text = Microsoft.VisualBasic.Right _
                ("00" & endTimeS, 2)
            TextBoxUploadEndTimeCodeMin.Text = Microsoft.VisualBasic.Right _
                ("00" & endTimeM, 2)
            TextBoxUploadEndTimeCodeHour.Text = Microsoft.VisualBasic.Right _
                ("00" & endTimeH, 2)
        End If
    End Sub
    ...
    Private Sub StoreImgToDb(ByVal img As Bitmap, ByVal column As String)
        ...
        Dim sqlconn As SqlConnection = New SqlConnection(ConnStr)
        Dim queryString As String = "update upload set " & _
                                    column & " = @screenshot " & _
                                    "where " & _
                                    "material_id = @material_id"
    ...
    Private Sub Panel3_MouseMove _
    ...
    Private Sub Panel2_MouseMove _
        (ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) _
    ...
    Private Sub Panel1_MouseMove _
        (ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) _
    ...
    Private Sub ComboBoxTaskType_SelectedIndexChanged _
        ...
        If ComboBoxTaskType.SelectedItem.ToString = "VRT上载" Then
            ...
            ComboBoxSignalSource.Items.AddRange(New Object() {"录像机1", "录像机2", "录像机3"})
        End If

        If ComboBoxTaskType.SelectedItem.ToString = "线路上载" Then
            ComboBoxSignalSource.Items.Clear()
            ComboBoxSignalSource.Items.AddRange(New Object() {"线路信号1", "线路信号2", "线路信号3"})
